...
//        target.strokeType = StrokeType.CENTERED
    ...
    companion object {
        ...
        private val Color.asSkiaColor get() = Color4f(
            r = red / 255.0f,
            g = green / 255.0f,
            b = blue / 255.0f,
            a = alpha / 255.0f
